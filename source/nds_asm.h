...
#define BG_GFX				0x6000000		/** \brief background graphics memory*/
#define BG_GFX_SUB			0x6200000		/** \brief background graphics memory (sub engine)*/
#define SPRITE_GFX			0x6400000		/** \brief sprite graphics memory*/
#define SPRITE_GFX_SUB		0x6600000		/** \brief sprite graphics memory (sub engine)*/
...
#define MOSAIC_CR			0x4C

#define BLEND_CR			0x50
#define BLEND_AB			0x52
#define BLEND_Y				0x54
